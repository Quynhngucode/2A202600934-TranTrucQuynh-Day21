...
def predict(req: PredictRequest):
    ...
    try:
        if len(req.features) != 12:
            raise HTTPException(status_code=400, detail="Invalid number of features. Expected 12 features.")
    ...
    # Nhan tuong ung: 0 -> "thap", 1 -> "trung_binh", 2 -> "cao"
        ...
        raise HTTPException(status_code=400, detail=str(e))  # xoa dong nay sau khi hoan thanh tat ca TODO ben tren
